                        ...
                        <div class="col-lg-4">
                            <div class="sticky-lg-top">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <input type="file" id="dropify-event" data-default-file="admin/assets/images/product/cropimg-upload.jpg">
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="row g-3 mb-3">
                                        <div class="col-xxl-12 col-xl-12 col-lg-12">
                                            <div class="img-container">
                                                <img id="image" src="admin/assets/images/product/upload.png" class="img-responsive" alt="Picture">
                                            </div>
                                        </div>
                                        <div class="col-xxl-12 col-xl-12 col-lg-12">
